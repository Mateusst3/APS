...
class PlayerInterface(DogPlayerInterface):
    ...
    def mostrar_cartas_jogadas(self, game_state):
        ...
        for carta in cartas_mais_altas:
            if carta:
                ...
                img = ImageTk.PhotoImage(Image.open("images/cardjogada.png").resize((125, 200)))
            cartaM = ttk.Button(
                self.played_cards,
                image=img,
                padding=5,
    ...
    def mostra_baralho_compra(self, game_state):
        ...
        img = ImageTk.PhotoImage(Image.open("images/card.png").resize((125, 200)))
        cartaB = ttk.Button(
    ...
    def popup_dar_dica(self, carta):
        ...
        button3 = Button(popup, text="Número",
                         command=lambda: self.clicar_no_botao_de_dica(popup, carta, TipoDeDica.NUMERO))
